...
class ExpectationResult:
    ...
    value : Union[float, np.ndarray]
        ...
        multiple probabilities, this will be a matrix with shape (len(probs), n_cols).
        Otherwise it will be a scalar or vector.
...
def e_loo(
    ...
    *,
    ...
    log_ratios : array-like, optional
        Raw (not smoothed) log ratios with same shape as x. If provided, these are
        used to compute more accurate Pareto k diagnostics.
